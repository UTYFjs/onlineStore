    ...
    <div className={styles['container']}>
      ...
      <ul>
        <li>
          ...
          изделий изготовленых на заказ. Все они уже радуют своих владельце, но всегда можно
          изготовить что то такое же при наличии необходимого материала :)
        </li>
        <li>
          Размещу здесь выполненные мною работы из натуральной кожи. все работы выполнены вручную
          без использования швейной машины, только ручная работа, только с душой :)
        </li>
        <li>
